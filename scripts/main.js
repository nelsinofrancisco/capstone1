...
function createFilmSection() {
  ...
  filmsContainer.setAttribute(
    'class',
    'films-container d-flex d-column d-align-center desk-w',
  );
  ...
  newfilmsContainer.setAttribute(
    'class',
    'film-div-container d-wrap d-flex d-column d-align-center',
  );
